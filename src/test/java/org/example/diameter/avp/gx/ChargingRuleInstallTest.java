...
class ChargingRuleInstallTest {
    ...
    public void chargingRuleInstall_ruleDefinition_encode() {
        ...
        //diameter.Session-Id == "string;459;844;IMSI999991234567810"
        //diameter.Session-Id == "string;459;844;IMSI999991234567810"
        byte[] bufferOrig = HexFormat.of().parseHex("");
        ...
        FlowInformation flowInformation11 = new FlowInformation();
        flowInformation11.setFlowDescription(new FlowDescription("permit in 17 from 172.17.241.255 17105 to 172.16.20.111/32"));
        flowInformation11.setFlowDirection(new FlowDirection(2));
        flowInformation11.setTosTrafficClass(new TosTrafficClass(HexFormat.of().parseHex("68fc")));

        FlowInformation flowInformation21 = new FlowInformation();
        flowInformation21.setFlowDescription(new FlowDescription("permit out 17 from 172.16.20.111/32 to 172.17.241.255 17105"));
        flowInformation21.setFlowDirection(new FlowDirection(1));
        flowInformation21.setTosTrafficClass(new TosTrafficClass(HexFormat.of().parseHex("68fc")));

        crd2.setFlowInformation(flowInformation11);
        crd2.setFlowInformation(flowInformation21);
        ...
        //assertThat(encoded).isEqualTo(bufferOrig);
    }
    ...
    private void assertEncoded(byte[] actual,ChargingRuleInstall criExpected) {
        ...
        for (int i=0;i<cri.getData().getChargingRuleDefinition().size();i++){
            ...
            assertThat(cri.getData().getChargingRuleDefinition().getFirst().getData().getFlowInformation().size()).isEqualTo(2);
            assertThat(cri.getData().getChargingRuleDefinition().getFirst().getData().getFlowInformation().getFirst().getData().getFlowDescription().getData())
                    .isEqualTo(criExpected.getData().getChargingRuleDefinition().getFirst().getData().getFlowInformation().getFirst().getFlowDescription().getData());
