...
@AvpRegister(avpCode = 1010,avpBuilderMethod = "byteToAvp")
public class Precedence extends Avp<Integer> {
    public static int avpCode = 1010;
    public static byte flags = (byte) 0xc0;

    public Precedence(AvpHeader header, byte[] buffer, int position) {
        super(header, buffer, position);
    }

    public Precedence(Integer data) {
        super(data);
    }

    public static AvpBuilder byteToAvp(){
        return new AvpBuilder(Precedence::new);
    }
