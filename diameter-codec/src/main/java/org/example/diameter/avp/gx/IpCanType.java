...
@AvpRegister(avpCode = 1027,avpBuilderMethod = "byteToAvp")
public class IpCanType extends Avp<Integer> {
    public static int avpCode = 1027;
    public static byte flags = (byte) 0xc0;

    public IpCanType(AvpHeader header, byte[] buffer, int position) {
        super(header, buffer, position);
    }

    public IpCanType(Integer data) {
        super(data);
    }

    public static AvpBuilder byteToAvp(){
        return new AvpBuilder(IpCanType::new);
    }
